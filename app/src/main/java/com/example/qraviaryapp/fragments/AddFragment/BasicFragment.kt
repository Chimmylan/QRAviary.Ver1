...
//        }
        ...
        newBundle.putSerializable("BirdMutation1", birdData.mutation1)
        newBundle.putSerializable("BirdMutation2", birdData.mutation2)
        newBundle.putSerializable("BirdMutation3", birdData.mutation3)
        newBundle.putSerializable("BirdMutation4", birdData.mutation4)
        newBundle.putSerializable("BirdMutation5", birdData.mutation5)
        newBundle.putSerializable("BirdMutation6", birdData.mutation6)
