...
class FemaleBirdListAdapter(
    private val context: Context,
    private val dataList: MutableList<BirdData>,
    private val clickListener: ClickListener
) : RecyclerView.Adapter<FemaleViewHolder>() {

    companion object {
        private const val MAX_MUTATION_LENGTH = 10
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FemaleViewHolder {


        val view = LayoutInflater.from(context).inflate(R.layout.item_birdlist,parent,false)

        return FemaleViewHolder(view, dataList, context as FemaleBirdListActivity)
    }



    override fun onBindViewHolder(holder: FemaleViewHolder, position: Int) {
...
class FemaleViewHolder(
    itemView: View,
    private val dataList: MutableList<BirdData>,
    private val activity: FemaleBirdListActivity
